(function (window) {
    ...
    collectable.init = function (game) {
        ...
        // example: 
        collectable.create(type.max, 300, 170, 10, .2);
        collectable.create(type.steve, 50, 70, 10, .2);
        collectable.create(type.grace, 600, 120, 10, .2 );
        collectable.create(type.kennedi, 215, 81, 10, .2);
